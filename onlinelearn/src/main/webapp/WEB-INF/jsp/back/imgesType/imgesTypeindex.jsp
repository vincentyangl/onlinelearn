...
<!--                                  <h6 class="modal-title" align="left" id="myModalLabel">****</h6> -->
								<div class="col-sm-9">
								    <input  type="hidden" class="form-control zh" id="type_id" name="type_id" >
									<input placeholder="请输入需要添加的图片类型" type="text" class="form-control zh" id="type_name2" name="type_name2" value="">
								</div>
							</div>
							</div>
                          ...
                          <c:forEach items="${list}" var="p" varStatus="statu">
                              <tr>
                                <td>${p.type_id }</td>
                                 <td>${p.type_name}</td>
                                <td>
<%--                                 <a href="/admin/imagetype/update/${p.type_id}" class="btn btn-default">修改</a>                               ,${p.type_name}--%>
                                 <button type="button"  class="btn btn-default" data-toggle="modal" data-target="#myModal3" onclick="up(${p.type_id })">修改</button>
                                 <a href="/admin/imagetype/delete/${p.type_id}" class="btn btn-default">删除</a>
                                  </td>
                              </tr>
                          </c:forEach>
                          </tbody>
