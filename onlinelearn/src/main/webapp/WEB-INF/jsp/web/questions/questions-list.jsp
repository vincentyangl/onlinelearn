						...
						<div class="js-wrap">
							...
							<section class="fl">
								<ol class="js-tap clearfix">
									<li><a
										href="/front/equestions/edlist/1" title="最新">最新</a></li>
									<li><a
										href="/front/equestions/edlist/2" title="热门">热门</a></li>
									<li><a
										href="/front/equestions/edlist/3" title="等待回答">等待回答</a></li>
								</ol>
							</section>
						</div>
						<!-- /问题列表 开始 -->
												...
												<aside class="q-head-pic">
													<c:choose>
														<c:when test="${not empty question.edu_User.picImg }">
															<img src="${question.edu_User.picImg }" alt="">
														</c:when>
														<c:otherwise>
													...
													<p class="hLh30 txtOf">
														<span class="c-999"> <c:if
																test="${empty question.edu_User.showName }">${question.edu_User.email }</c:if>
															<c:if test="${not empty question.edu_User.showName }">${question.edu_User.showName }</c:if>
														</span>
													</p>
												</aside>
												<section class="q-txt-box">
													...
													<h3 class="hLh30 txtOf">
														<em class="icon16 q-tw">&nbsp;</em> <a
															href="/front/equestions/webedgetById/${question.id }" title=""
