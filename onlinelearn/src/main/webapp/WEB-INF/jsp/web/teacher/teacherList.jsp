			...
			<header class="comm-title all-teacher-title">
				...
				<section class="c-tab-title">
					...
					<c:forEach items="${lists }" var="s"  >
						<a  title="${s.subjectName }" href="/front/teacher/getBySid/${s.subjectId}">${s.subjectName }</a>
					</c:forEach>
				</section>
			</header>
									...
									<li>
										<section class="i-teach-wrap">
											<div class="i-teach-pic">
												<a href="/front/teacher/getById/${teacher.id}" title="${teacher.name }">
													<c:choose>
											...
											<div class="mt10 hLh30 txtOf tac">
												<a href="/front/teacher/getById/${teacher.id}" title="${teacher.name }" class="fsize18 c-666">${teacher.name }</a>
											</div>
