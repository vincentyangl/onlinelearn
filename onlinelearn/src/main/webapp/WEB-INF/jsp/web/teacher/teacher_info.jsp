					...
					<div class="mt20 ml20">
						<section class="t-infor-pic">
							<c:choose>
								...
								<c:otherwise>
									<img xSrc="${ctx }/static/inxweb/img/default-tea-img.gif"
										src="/static/inxweb/img/default-tea-img.gif" alt="">
								</c:otherwise>
							</c:choose>
						</section>
						<h3 class="hLh30">
											...
											<section class="course-img">
												<c:choose>
													<c:when test="${not empty course.logo }">
														<img xSrc="<%=staticImage%>${course.logo}"
															src="${ctx }/static/inxweb/img/default-img.gif"
															class="img-responsive" alt="">
													</c:when>
													<c:otherwise>
														<img xSrc="/static/inxweb/img/default-img.gif"
															src="${ctx }/static/inxweb/img/default-img.gif"
															class="img-responsive" alt="">
													</c:otherwise>
												</c:choose>
