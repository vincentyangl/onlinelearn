							...
							<section class="hLh30 txtOf mt5 pb20 mreadnum">
								<div class="fr">
									<span> <a class="noter-dy vam" title="评论" href="#i-art-comment">
										...
										</a> <tt title="赞一下" onclick="addPraise('${edu_Article.articleId}',3)" class="noter-zan vam ml5 f-fM">
											<em class="icon18">&nbsp;</em>(<span class="addPraise${edu_Article.articleId}_3 praiseCount">0</span>)
										</tt>
									</span>
								</div>
								<div class="fl pt3"><%--  <tt class="c-999 f-fM">来源：${article.source }</tt>  --%><tt class="c-999 f-fM">
										<!-- 1小时前发布 -->
										<fmt:formatDate value="${edu_Article.publishTime }" pattern="yyyy-MM-dd HH:mm" />
								</tt>
								</div>
							</section>
							<div id="art-infor-body">${edu_Article.edu_Article_Content.content  }
								<div>
									<tt class="c-999 f-fM">
										...
										点赞：<span class="addPraise${edu_Article.articleId}_3 praiseCount">0</span>
									</tt> <tt class="c-999 f-fM ml20">
							...
							<section class="mt20 tac" id="sharebutton">
								<div class="bdsharebuttonbox clearfix disIb">
									<div class="pr disIb fl of">
										<a href="javascript:void(0)" onclick="addActiclePraise('${edu_Article.articleId}',3)"  title="" class="zan-icon dz-btn pr"></a>
										<div class="dz-num">
