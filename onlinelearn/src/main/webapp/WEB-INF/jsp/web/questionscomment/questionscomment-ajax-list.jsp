						...
						<li>
							<aside class="noter-pic">
								<c:choose>
									<c:when test="${not empty questionsComment.edu_User.picImg}">
										<img
											src="<%=staticImage %>${questionsComment.edu_User.picImg}"
							...
							<div class="of hLh20">
								<span class="fl"> <font class="fsize12 c-blue"> <c:if
											test="${not empty questionsComment.edu_User.showName}">${questionsComment.edu_User.showName}</c:if>
										<c:if test="${empty questionsComment.edu_User.showName}">${questionsComment.edu_User.email }</c:if>
							...
							<div class="of mt5">
								<span class="fr"><font class="fsize12 c-999 ml5"><fmt:formatDate
											type="both" value="${questionsComment.addTime }"
									...
									onclick="getCommentById(this,${questionsComment.id })"> <em
										class="icon18">&nbsp;</em>全部评论(<span>${questionsComment.replyCount }</span>)
				...
				<ul class="pr10">
					<c:forEach items="${comments1}" var="questionsComment"
						...
						<li>
							...
							<div class="of hLh20">
								<c:if
									test="${questionsCommentList.status==0 and  questionsCommentList.cus_id==edu_User.user_id and questionsComment.cus_id != edu_Questions.cus_id}">
							...
							<div class="of mt5">
								<span class="fr"><font class="fsize12 c-999 ml5">
									...
									onclick="getCommentById(this,${questionsComment.id})"> <em
										class="icon18">&nbsp;</em>(<span>${questionsComment.replyCount }</span>)
							...
							<div class="n-reply" style="display: none; padding-left: 0;">
								<div>
									...
									<input type="hidden" id="" name=""
										...
										value="${questionsComment.edu_Questions.id}" />
								</div>
								<div class="mt10 pl10 pr10">
									<dl class="n-reply-list">
										<!-- 当前问答回复的所有评论在这里 -->
