				...
				<ul class="pr10">
					<c:forEach items="${questions.questionsCommentList}" var="questionsComment">
						<li>
							...
							<div class="of hLh20">
								<span class="fl"> <font class="fsize12 c-blue"> <c:if test="${not empty questionsComment.edu_User.showName}">${questionsComment.edu_User.showName}</c:if> <c:if test="${empty questionsComment.showName }">${questionsComment.email }</c:if>
