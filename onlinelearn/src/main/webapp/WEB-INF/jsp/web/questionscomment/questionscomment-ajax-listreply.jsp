			...
			<aside class="n-reply-pic">
					<c:choose>
						<c:when test="${not empty questionsComment.edu_User.picImg }">
							<img src="<%=staticImage %>${questionsComment.edu_User.picImg }" alt="">
						</c:when>
						<c:otherwise>
			...
			<div class="of">
				<span class="fl">
					<font class="fsize12 c-blue">
						...
						<c:if test="${not empty questionsComment.edu_User.showName }">${questionsComment.edu_User.showName }</c:if>
