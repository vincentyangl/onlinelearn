									...
									<c:forEach items="${questionsList }" var="question">
										<li>
											...
											<section class="q-txt-box">
												<a class="replyBrowseNum" href="${ctx }/front/equestions/webedgetById/${question.id }" title="">
													<div class="replyNum">
												...
												<h3 class="hLh30 txtOf">
													...
													<a href="${ctx }/front/equestions/webedgetById/${question.edu_Questions.id }" title="" class="fsize16 c-333 vam">${question.edu_Questions.title }</a>
												</h3>
